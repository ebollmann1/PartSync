...
class ResConfigSettings(models.TransientModel):
    ...
    interval_unit_invoice = fields.Selection(string="Frequency", selection=[
        ('minutes', 'Minutes'),
        ('hours', 'Hours')], config_parameter='payment_ebizcharge_crm.interval_unit_invoice', required=True, default='hours')
    ...
    def activate_invoice_cron_job(self):
        try:
            ...
            if scheduler:
                ...
                scheduler.nextcall = self.next_execution_date_invoice or datetime.now()
